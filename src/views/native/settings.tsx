  ...
  return (
    <View style={{ flex: 1, backgroundColor: appPalette.ui.inputBackground }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 12 }}>
        ...
        <SurfaceCard><Text style={{ fontSize: 16, fontWeight: "600", color: appPalette.semantic.textStrong, fontFamily: "Montserrat" }}>Platform capabilities</Text><InfoRow label="Telegram login" value={platformCapabilities.telegramLogin ? "Доступен" : "Только web"} /><InfoRow label="File persistence" value={platformCapabilities.nativeFilePersistence ? "Прямое сохранение" : "Через внешнюю ссылку"} /></SurfaceCard>
