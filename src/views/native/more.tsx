    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={{ paddingHorizontal: 16, paddingTop: 12 }}>
          <ActionChip onPress={() => setActiveTab("menu")}>Назад</ActionChip>
        </View>
        <NativeFrensScreen />
      </View>
    );
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 12 }}>
        <SectionTabs
          tabs={[
            { key: "menu", label: "Разделы" },
            { key: "frens", label: "Друзья" },
        ...
        <SurfaceCard>
          <Text style={{ fontSize: 16, fontWeight: "600", color: "#0f172a" }}>Дополнительные экраны</Text>
          <Text style={{ color: "#64748b" }}>
            Здесь собраны разделы, которые не хочется тянуть в основной нижний таб-бар мобильного клиента.
          </Text>
