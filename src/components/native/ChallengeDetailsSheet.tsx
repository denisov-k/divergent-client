...
export function ChallengeDetailsSheet({ open, challenge, loading = false, participants, reports, onOpenChange, onDownload, onKick }: { open: boolean; challenge: Challenge; loading?: boolean; participants: ChallengeParticipant[]; reports: Report[]; onOpenChange: (open: boolean) => void; onDownload: (reportId: string) => Promise<boolean>; onKick: (challengeId: string, userId: string) => Promise<void>; }) {
